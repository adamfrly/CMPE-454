...
class World {
    ...
    char* showMsg;
    int  score;
    float altitude;     //Added for displaying altitude
    bool landedFlag = false;    //Added to check if successful landing was made
    bool winFlag;   //Added to check if the lander crashed
