...
class Lander {
  ...
  vec3 position;		// position in world coordinates (m)            --Need a getter for this as it's not public
 ...
 public:
  ...
  vec3 getPosition() { return position; }       //Added position getter to be used in world.cpp during landing
};
