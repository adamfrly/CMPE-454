...
class Landscape {
 ...
 public:
  ...
  float getAltitude(int segIdx, vec3 cPos, float height);       //Used to find and display altitude
  int findLandingSegment(vec3 cPos);                            //Used to find index of segment to land on
};
