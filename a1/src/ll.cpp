...
#else
  glfwWindowHint(GLFW_CLIENT_API, GLFW_OPENGL_API);         //Changed this code in order to make it run on windows
  glfwWindowHint(GLFW_CONTEXT_VERSION_MAJOR, 3);
  glfwWindowHint(GLFW_CONTEXT_VERSION_MINOR, 3);                        //Changed version_minor to 3
