...
void wfModel::readMaterialLibrary(const char* name)
...
wfMaterial* wfModel::findMaterial(const char* name)
...
wfGroup* wfModel::findGroup(const char* name)
...

{
    ...
    cout << "setupVAO: " << groups.size() << " groups" << endl;
    ...
    for (int i = 0; i < groups.size(); i++) {
        ...
        cout << "  group " << i << ", " << numTriangles << " triangles" << endl;
