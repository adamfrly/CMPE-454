...
class Scene {
 ...
 public:
  ...
  Scene() {
    ...
    stop = false;
    jitter = false;
<<<<<<< Updated upstream:a4/a4/src/scene.h
    numPixelSamples = 3;
=======
    numPixelSamples = 2;
>>>>>>> Stashed changes:a4/src/scene.h
    debug = false;
    debugPixel = vec2(-1,-1);
    sceneScale = 1;
    showBVH = false;
...
<<<<<<< Updated upstream:a4/a4/src/scene.h
  vec3 raytrace( vec3 &rayStart, vec3 &rayDir, int depth, int thisObjIndex, int thisObjPartIndex, float prodSpecular );
=======
